...
Содержание:
* **`Заинтересованные лица проекта.docx`**
* **`Концепция продукта и границы проекта.docx`**
* **`Способы представления границ проекта.docx`**
* **`Классификация предоставляемой клиентом информации.docx`**
* **`Диаграммы вариантов использования.docx`**
* **`Описание вариантов использования.xlsx`**
